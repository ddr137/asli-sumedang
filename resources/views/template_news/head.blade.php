...
<head>
	...
	<title>Asli Sumedang</title>

	<!-- Google font -->
	<link href="https://fonts.googleapis.com/css?family=Montserrat:400,700%7CMuli:400,700" rel="stylesheet">

	<!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="{{ asset('main-frontend/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">


	<!-- Font Awesome Icon -->
	<link rel="stylesheet" href="{{ asset('main-frontend/css/font-awesome.min.css') }}">

	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="{{ asset('main-frontend/css/style.css') }}" />
		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<img src="{{ asset('assets/img/logo/asli-smd-logo-colour.png')}}" alt="logo" width="150px" height="50px" class="mt-3">
					</div>
					<!-- /logo -->
