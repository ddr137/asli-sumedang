...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'Postingan berhasil dihapus (Silahkan cek trashed post)');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success', 'Postingan berhasil direstore (Silahkan cek list postingan)');
    }
    ...
    public function kill($id) {
        ...
        return redirect()->back()->with('success', 'Postingan berhasil dihapus selamanya');
    }
}
